...
public class PreferItemsAdapter extends RecyclerView.Adapter<PreferItemsAdapter.ViewHolder> {
    ...
    private PreferItemsAdapter.ClickPreferListener mClickPreferListener;
    ...
    public void setClickPreferListener(PreferItemsAdapter.ClickPreferListener listener) {
        mClickPreferListener = listener;
    }

    @Override
    public PreferItemsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_prefer, null);
        return new PreferItemsAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final PreferItemsAdapter.ViewHolder holder, int position) {
